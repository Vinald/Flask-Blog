...
class TestPostCreation:
    ...
    def test_create_post_requires_login(self, client):
        ...
        response = client.get('/api/v1/blog/create', follow_redirects=True)
    ...
    def test_create_post_page_loads(self, authenticated_client):
        ...
        response = authenticated_client.get('/api/v1/blog/create')
    ...
    def test_create_post_short_title(self, authenticated_client):
        ...
        assert response.status_code == 200
        assert b'between 3 and 200 characters' in response.data or b'at least 3 characters' in response.data
...
class TestPostViewing:
    ...
    def test_view_post(self, client, test_post):
        ...
        response = client.get(f'/api/v1/blog/post/{test_post.id}')
    ...
    def test_view_nonexistent_post(self, client):
        ...
        response = client.get('/api/v1/blog/post/99999', follow_redirects=True)
...
class TestPostEditing:
    ...
    def test_edit_post_requires_login(self, client, test_post):
        ...
        response = client.get(f'/api/v1/blog/post/{test_post.id}/edit', follow_redirects=True)

        assert b'log in' in response.data.lower()

    def test_edit_own_post_page_loads(self, authenticated_client, test_post):
        """Test that edit page loads for post owner."""
        response = authenticated_client.get(f'/api/v1/blog/post/{test_post.id}/edit')
    ...
    def test_edit_post_success(self, authenticated_client, test_post):
        ...
        response = authenticated_client.post(f'/api/v1/blog/post/{test_post.id}/edit', data={
...
class TestPostDeletion:
    ...
    def test_delete_post_requires_login(self, client, test_post):
        ...
        response = client.post(f'/api/v1/blog/post/{test_post.id}/delete', follow_redirects=True)
    ...
    def test_admin_can_delete_any_post(self, authenticated_admin_client, test_post, app):
        ...
        response = authenticated_admin_client.post(f'/api/v1/blog/post/{post_id}/delete', follow_redirects=True)
...
class TestMyPosts:
    ...
    def test_my_posts_requires_login(self, client):
        ...
        response = client.get('/api/v1/blog/my-posts', follow_redirects=True)

        assert b'log in' in response.data.lower()

    def test_my_posts_page_loads(self, authenticated_client):
        """Test that My Posts page loads."""
        response = authenticated_client.get('/api/v1/blog/my-posts')
...
class TestAuthorPosts:
    ...
    def test_author_posts_page_loads(self, client, test_user, test_post):
        ...
        response = client.get(f'/api/v1/blog/author/{test_user.id}')
    ...
    def test_author_posts_nonexistent_user(self, client):
        ...
        response = client.get('/api/v1/blog/author/99999', follow_redirects=True)
...
class TestPostSearch:
    ...
    def test_search_empty_query(self, client):
        ...
        response = client.get('/api/v1/blog/search?q=', follow_redirects=True)
